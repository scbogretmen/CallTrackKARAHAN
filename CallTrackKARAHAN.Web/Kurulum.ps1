# CallTrack KARAHAN - Tek tikla otomatik kurulum
...
$HedefKlasor = "C:\CallTrackKARAHAN"
$VarsayilanPort = 5520
$YedekPort = 5521
...
$ExeAdi = "CallTrackKARAHAN.Web.exe"
...
Write-Host "CallTrack KARAHAN kurulumu basliyor..." -ForegroundColor Cyan

# C:\CallTrackKARAHAN olustur ve tum calisacak dosyalari oraya kopyala (proje nerede olursa olsun)
...
# Port secimi: 5520 mesgulse 5521 kullan
...
if ($PortMesgul) {
    ...
    [Environment]::SetEnvironmentVariable("ASPNETCORE_URLS", "http://0.0.0.0:$VarsayilanPort", "Machine")
}

# Guvenlik duvari kurali (varsa atla)
$KuralAdi = "CallTrack KARAHAN Port $KullanilacakPort"
